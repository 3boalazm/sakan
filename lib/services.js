...
const CURRICULUM = [
  ...
  { type:'video',  stage:1, order:206, priority:'later',  title:'ايه المشكلة في الزواج (حلقة 2)', link:'https://youtu.be/_57DQt0CP48', purpose:'استكمال المشكلات وبداية الحلول.' },
  { type:'video',  stage:2, order:207, priority:'medium', title:'المرأة الذكية ومفاتيح الرجل', speaker:'الشيخ أبو إسحاق الحويني', link:'https://youtu.be/GYi_DS_5yHs', purpose:'فهم الفروقات النفسية والتعامل معها.' },
  ...
  { type:'video',  stage:3, order:218, priority:'medium', title:'كيف نبني زواجًا مستقرًا', speaker:'د. جاسم المطوع (بودكاست بدون ورق)', link:null, purpose:'استراتيجيات عملية لبناء الاستقرار في العلاقة.' },
  { type:'video',  stage:3, order:219, priority:'medium', title:'مفهوم القوامة', speaker:'د. الحارث المزيدي (بودكاست مسار)', link:null, purpose:'القوامة كخدمة ومسؤولية لا تسلّط، وتقاطعها مع تحديات العصر.' },
];
